...
namespace SntBackend.DomainService.SettingDefinitions
{
            ...
            return new[]
                   {
                       ...
                       new SettingDefinition(EmailSettingNames.DefaultFromDisplayName, "SntBackend System", L("DefaultFromSenderDisplayName"))
                   };
        }
