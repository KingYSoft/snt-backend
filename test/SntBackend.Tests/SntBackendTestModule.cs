...
namespace SntBackend.Tests
{
    ...
    public class SntBackendTestModule : AbpModule
    {
        public SntBackendTestModule()
        {
        }
        ...
        public override void PreInitialize()
        {
            ...
            facadeConfiguration.AppName = "SntBackend_Tests";
        ...
        {
            var thisAssembly = typeof(SntBackendTestModule).GetAssembly();
